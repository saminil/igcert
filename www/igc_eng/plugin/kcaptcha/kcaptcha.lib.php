...
function captcha_html($class="captcha")
{
    ...
    if (!is_mobile()) $html .= "\n".'<button type="button" id="captcha_mp3"><span></span>Listening to voice numbers</button>';
    $html .= "\n".'<button type="button" id="captcha_reload"><span></span>Refresh</button>';
    $html .= "\n".'<span id="captcha_info">Enter the number of automatic registration prevention in order.</span>';
    $html .= "\n".'</fieldset>';
    return $html;
}
