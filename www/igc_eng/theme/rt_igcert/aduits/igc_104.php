		...
		<div class="con_area">
			<div class="thumb">
              <a href="./igc_104_ISO9001.php">
			    <h3>Part 1</h3>
				<img src="../image/audits_01.jpg" alt="Auditor Certification Part 1">
              </a>
			</div>
			<div class="txtArea">
				<ul>
        ...
        <div class="con_area">
			<div class="thumb">
              <a href="./igc_108_ISOIEC22000-1.php">
			    <h3>Part 2</h3>
				<img src="../image/audits_02.jpg" alt="Auditor Certification Part 2">
              </a>
			</div>
			<div class="txtArea">
				<ul>
  		...
  		<div class="con_area">
			<div class="thumb">
              <a href="./igc_112_ISO22000.php">
			    <h3>Part 3</h3>
				<img src="../image/audits_03.jpg" alt="Auditor Certification Part 3">
              </a>
			</div>
			<div class="txtArea">
				<ul>
