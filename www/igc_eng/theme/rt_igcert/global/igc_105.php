...
<div class="content_wrap">
	<section class="page_title">
        <h1 class="sub_tit"><span>Training Provider</span>&nbsp;Designated Service List</h1>
	</section>
	
	<div class="txt">
        <h3 class="fc_pointer">What is the designation of a Training Provider?</h3><br> <br>
        <p style="text-align:justify;">
		    The designation of a Training Provider means the official designation of an institution that provides educational services for training professional based on standards applicable to all personnel in various industries.<br><br>
            IPC (International Personnel Certification Association) has signed an MLA with the IAF (International Accreditation Forum) for IPC’s activities (Personnel Certification and Training Provider Designation), and the GPC (Global Personnel Certification), a full member of the IPC, is working on the designation of Training Provider based on this.<br><br>
            IGC provides designated Training Provider services in cooperation with GPC.
        </p>
    </div>
		...
		<div class="con_area">
			<div class="thumb">
              <a href="igc_116_012.php">
			    <h3>Overview</h3>
				<img src="../image/Training_institutions_list_02.jpg" alt="Training Provider Overview image">
              </a>
			</div>
			<div class="txtArea">
				<ul>
					<li><a href="igc_116_012.php"><span><div  class="arrow test_4"></div>Overview</span></a></li>
				</ul>
			</div>
		</div>		
        <div class="con_area">
			<div class="thumb">
              <a href="igc_117_01.php">
			    <h3>Procedure of Training Provider Designation</h3>
				<img src="../image/Training_institutions_list_01.jpg" alt="Procedure of Training Provider Designation image">
              </a>
			</div>
			<div class="txtArea">
				<ul>
					<li><a href="igc_117_01.php"><span><div  class="arrow test_4"></div>Procedure of Training Provider Designation</span></a></li>
				</ul>
			</div>
		</div>
		<div class="con_area">
			<div class="thumb">
              <a href="igc_118_01.php">
			    <h3>Invigilator</h3>
				<img src="../image/Training_institutions_list_03.jpg" alt="Invigilator image">
              </a>
			</div>
			<div class="txtArea">
				<ul>
					<li><a href="igc_118_01.php"><span><div  class="arrow test_4"></div>Invigilator</span></a></li>
				</ul>
			</div>
		</div>
	</section>
