		...
		for($b=0; $b < count($page_block_arr); $b++) {
			...
			if(preg_match("/".$page_key."\/(igc_)/i", $_SERVER["PHP_SELF"])) { // 페이지 경로로 페이지 블럭 설정
				...
				if($page_key == "manage"){
					...
					$pages[1][$page_key] = array("품질경영 인증", $page_folder."igc_006_ISO9001.php", "_self"); // 왼쪽 메뉴 1
					$pages[2][$page_key] = array("환경 인증", $page_folder."igc_007_ISO14001.php", "_self"); // 왼쪽 메뉴 2
					$pages[3][$page_key] = array("안전보건 인증", $page_folder."igc_008_OHSAS18001.php", "_self"); // 왼쪽 메뉴 3
					$pages[4][$page_key] = array("보건&의료기기 인증", $page_folder."igc_010_ISO13485.php", "_self"); 	// 왼쪽 메뉴 4
					$pages[5][$page_key] = array("식품 인증", $page_folder."igc_014_ISO22000.php", "_self"); // 왼쪽 메뉴 5
					$pages[6][$page_key] = array("에너지 경영인증", $page_folder."igc_018_ISO50001.php", "_self"); // 왼쪽 메뉴 6
					$pages[7][$page_key] = array("정보보안 인증", $page_folder."igc_019_ISO27001.php", "_self"); // 왼쪽 메뉴 7
					$pages[8][$page_key] = array("부패방지 인증", $page_folder."igc_021ISO37001.php", "_self"); // 왼쪽 메뉴 8
					$pages[9][$page_key] = array("교육 인증", $page_folder."igc_022_ISO21001.php", "_self"); // 왼쪽 메뉴 9
					$pages[10][$page_key] = array("사업연속성 인증", $page_folder."igc_023_ISO22301.php", "_self"); // 왼쪽 메뉴 10
					$pages[11][$page_key] = array("화장품 인증", $page_folder."igc_024_ISO22716.php", "_self"); // 왼쪽 메뉴 11
					$pages[12][$page_key] = array("고객만족 인증", $page_folder."igc_025_ISO10002.php", "_self"); // 왼쪽 메뉴 12
					$pages[13][$page_key] = array("사회적 책임 인증", $page_folder."igc_026_SA8000.php", "_self"); // 왼쪽 메뉴 13
				}
				if($page_key == "medical"){
...
<div class="left_cs">
	<h2>CS Center</h2>
	<p class="tel">Tel. 02-6749-0701</p>
