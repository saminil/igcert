...
<div id="mb_confirm" class="mbskin">
    ...
    <p>
        ...
        If you enter your password, membership withdrawal is completed.
        <?php }else{ ?>
        Confirm your password once more to keep your information safe.
        <?php }  ?>
    </p>
    ...
    <fieldset>
        ...
        <label for="confirm_mb_password" class="sound_only">Password<strong>Necessary</strong></label>
