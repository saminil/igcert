	...
	<article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <div class="cm_wrap">
            ...
            <header style="z-index:<?php echo $cmt_sv; ?>">
	            <h2><?php echo get_text($list[$i]['wr_name']); ?>user's <?php if ($cmt_depth) { ?><span class="sound_only">Of comments</span><?php } ?> Comment</h2>
	            <?php echo $list[$i]['name'] ?>
	            <?php if ($is_ip_view) { ?>
	            <span class="sound_only">IP</span>
	            <span class="mobile_no">(<?php echo $list[$i]['ip']; ?>)</span>
	            <?php } ?>
	            <span class="sound_only">Date Created</span>
		...
		<div class="bo_vl_opt">
            <button type="button" class="btn_cm_opt btn_b01 btn"><i class="fa fa-ellipsis-v" aria-hidden="true"></i><span class="sound_only">Comment optionsspan></button>
        	<ul class="bo_vc_act">
                <?php if ($list[$i]['is_reply']) { ?><li><a href="<?php echo $c_reply_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', 'c'); return false;">Comment</a></li><?php } ?>
...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <?php if ($comment_min || $comment_max) { ?><strong id="char_cnt"><span id="char_count"></span>Letters</strong><?php } ?>
    <textarea id="wr_content" name="wr_content" maxlength="10000" required class="required" title="Contents" placeholder="Please enter your comment" 
    ...
    <div class="bo_vc_w_wr">
        ...
        <div class="btn_confirm">
            ...
            <button type="submit" id="btn_submit" class="btn_submit">Comment registration</button>
        </div>
    </div>
    </form>
</aside>
...
function fviewcomment_submit(f)
{
    ...
    if (char_min > 0 || char_max > 0)
    {
        ...
        {
            alert("Comments must be written at least "+char_min+"");
            return false;
        } else if (char_max > 0 && char_max < cnt)
        {
            alert("Comments must be written at least "+char_max+" characters.");
            return false;
        }
    }
