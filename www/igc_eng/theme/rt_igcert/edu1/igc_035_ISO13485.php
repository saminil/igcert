...
<div class="content_wrap">
    <section class="business_type5" class="area">
        <h1 class="tit_num">ISO 13485 Professional Training</h1>
		<h2 class="tit_cer fc_pointer">Medical devices quality management system training course</h2>

		<ul class="content">
            <li><!-- content 01 -->
				<dl>
					<dt class="img_area">
						<img src="./images/edu_iso_13485_01.jpg" alt="ISO 13485:2016 Outline">
					</dt>
					<dd class="txt_area">
                        <h3 class="con_tit">ISO 13485:2016 Outline</h3>
                        <p style="text-align:justify">
                            Medical devices have a direct impact on human life and health, so they need to guarantee a higher level of stability than any other product. Therefore, the medical device industry has a variety of regulations that must be met, including domestic regulatory systems, international standards and other requirements.<br><br>
                            ISO 13485 is a standard that stipulates the requirements for the quality management system of organizations providing medical device design and development, production, installation and additional services.<br><br>
			...
			<li><!-- content 02 -->
				<dl>
					<dt class="img_area">
					    <img src="./images/edu_iso_13485_03.jpg" alt="The importance of ISO 13485 training">
					</dt>
					<dd class="txt_area">
                        <h3 class="con_tit">The importance of ISO 13485 training</h3>
                        <p style="text-align:justify">
                            Medical devices have a direct impact on human life and health, so they need to guarantee a higher level of stability than any other product.<br><br>
                            For the effective application of the standard ISO 13485, companies and industries need qualified professionals. The purpose of the ISO 13485 Auditor Certification process is to provide the certification body with the confidence that auditors and individuals certified through this program are eligible.<br><br>
