...
$g5['title'] = 'Risk management';//<!------서브페이지 최상위 타이블, css/design.css 파일 Line 425 ~ line 430까지 참조-------> 
...
<div class="content_wrap">
    <section class="business_type5" class="area">
        <h1 class="tit_num">ISO 31000 Professional Training</h1>
		<h2 class="tit_cer fc_pointer">Risk Management Guideline Training Course</h2>
		
		<ul class="content">
		    <li><!-- content 01 -->
				<dl>
					<dt class="img_area">
						<img src="./images/edu_iso31000_01.jpg" alt="ISO 31000:2018 Outline">
					</dt>
					<dd class="txt_area">
                        <h3 class="con_tit">ISO 31000:2018 Outline</h3>
                        <p style="text-align:justify">
                            It is recommended that organizations develop, implement, and continually improve a framework that aims to integrate risk management processes into their overall management, strategy and planning, management, reporting process, policies, values and culture.<br><br>
			...
			<li><!-- content 02 -->
				<dl>
					<dt class="img_area">
						<img src="./images/edu_iso31000_03.jpg" alt="The importance of ISO 31000 training">
					</dt>
					<dd class="txt_area">
                        <h3 class="con_tit">The importance of ISO 31000 training</h3>
                        <p style="text-align:justify">
                            Risk is inherent in all activities. ISO 31000 can help with public and private, infrastructure and commerce that are risk-derived.<br><br>
                            For the effective application of ISO 31001, companies and industries need qualified professionals. The purpose of the ISO 31001 trainnig is to provide certification body, businesses and industries with the confidence that auditors and individuals trained through this program are eligible.<br><br>
