...
<style>
	...
	.vision_type2 ul {margin-top:50px; padding:0; }
	...
	.vision_type2 ul li .con_txt p {font-size:2rem; color:#000; text-align:left; }
...
<div class="content_wrap">
	<div class="page_title">
	    <img src="./images/banner03_07.png" alt="제품인증 절차">
		...
		<ul class="step_list">
			...
			<li class="inverse_li">
				...
				<div class="con_txt">
					...
					<span>
						<br>
						 (해당 시) 2단계 심사는 제품 인증 관련 규정 또는 지침에 대한 요구조건을 충족시키고 있는지에 대한 <br>실질적인 사실을 현장심사를 통하여 확인하기 위해 실시하며, <br>객관적인 사실에 의거 요구사항을 충족한다면 인증 추천을 받습니다.
					</span>
				</div>
			</li>
