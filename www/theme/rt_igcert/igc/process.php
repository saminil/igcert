...
<div class="content_wrap">
	<div class="page_title">
		<img src="./images/banner03_04.jpg" alt="시스템인증 배너">
		<h1 class="txtBox02">시스템인증 절차 안내</h1>
		<h2 class="sub_txt">인증신청 및 인증절차 안내입니다.</h2>
	</div>
	...
	<div class="vision_type2">
		...
		<div class="img_div"><img src="../image/img_1200.jpg" alt="인증절차"></div>
		...
		<ul class="step_list">
			...
			<li>
                ...
                <div class="step_txt">
                     ...
                     객관적인 사실에 의거 규격의 요구사항을 충족한다면 인증 등록을 추천을 받습니다.
				</div>
			</li>
