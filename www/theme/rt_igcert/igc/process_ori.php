...
<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons"> <!--구글폰트 기본셋팅링크 삽입 210629 YR-->
...
<div class="content_wrap">
	<div class="page_title">
		<img src="./images/banner03_04.jpg" alt="시스템인증 절차"><br><br><br>
		<h1 class="sub_tit"><span class="fc_pointer" style="color:#b1f5ef">시스템인증 절차</span>&nbsp안내</h1>
		<h2 class="sub_txt" style="color:red;">인증신청 및 인증절차 안내입니다.</h2>
	</div>

	<div class="vision_type2">
		<span class="stitle" style="display:block;text-align:justify">(주)아이지씨인증원은 시시각각 변화하는 글로벌 교류 분야에서 좀 더 빠르고 손쉽게 접근하는 방법을 연구합니다.
		...
		<ul>
			...
			<li class="inverse_li">
				...
				<div class="con_txt">
					...
					<span style="display:block;text-align:justify">
						<br>
						본 심사 전에 예비 심사를 통하여 시스템의 개선 기회를 부여하는데 목적이 있으며,
			...
			<li class="inverse_li">
				...
				<div class="con_txt">
					...
					<span style="display:block;text-align:justify">
						<br>
						 2단계 심사는 인증신청 규격과 조직의 경영시스템이 인증범위와 관련된 모든 요구조건을 충족시키고 있는 지에 대한 실제적인 사실을 현장심사를 통하여 확인하기 위하여 실시되며, 
	...
	<div class="vision_type5">
		...
		<ul>
			<li>
				<div class="i_box">
					<div class="icon"><i class="fab fa-medapps"></i><span class="material-icons" style="display:block;font-size:2.2em;margin-bottom:0px;color:#ffff;">open_in_full</span><em>인증의 확대 및 축소</em></div>
				</div>
				<div class="con_txt">
					<span style="display:block;text-align:justify">
					<h1>인증의 확대</h1>
		...
		<ul>
			<li>
				<div class="i_box">
					<div class="icon"><i class="fas fa-microscope"></i><span class="material-icons" style="display:block;font-size:2.2em;margin-bottom:0px;color:#ffff;">block</span><em>인증의 정지 및 취소</em></div>
				</div>
				<div class="con_txt">
				    <span style="display:block;text-align:justify">
