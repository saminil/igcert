	...
	<div class="wrap container animatedParent animateOnce" data-sequence="500">
		...
		<div class="txt animated fadeInUpShort" data-id="2">
			<div class="animatedParent animateOnce" data-sequence="250">
                <div class="txt_wrap">
                    <h2 class="con_tit animated fadeInUpShort" data-id="1">IGC인증원</h2>
                    ...
                    <p class="con_sub_tit animated fadeInUpShort" data-id="3">
        ...
        <div class="cs_top animated fadeInUpShort" data-id="3">
            <div class="main_about_img3">
                <p style="width:60px;height:60px;line-height:60px;text-align:center"><img src="/theme/rt_igcert/image/tel_tab.png" alt="tel 02-6749-0701" style="width:38px;height:auto;padding-bottom:4px"></p>
            </div>
            <div class="cs_num">
                <p>
                    <span class="cs_num_tit">대표번호</span>
                    <span class="cs_num_txt"><img src="/theme/rt_igcert/image/tel.png" alt="tel 02-6749-0701" class="cs_num_icon">02-6749-0701</span>
                </p>
                <p>
                    <span class="cs_num_tit time">이용시간</span>
        ...
        <div class="cs_bottom animated fadeInUpShort" data-id="4">
            <div class="cs_bot num01">
                <span style="letter-spacing: -0.09rem;">CE 전자기기, PED, 기계 제품 인증</span>
                <span class="cs_bottom_num"><img src="/theme/rt_igcert/image/tel.png" alt="tel 02-6749-1161" class="cs_num_icon">02-6749-1161</span>
            </div>
            <div class="cs_bot num02">
                <span>CE 의료기기 제품 인증</span>
                <span class="cs_bottom_num"><img src="/theme/rt_igcert/image/tel.png" alt="tel 02-6749-1186" class="cs_num_icon">02-6749-1186</span>
            </div>
            <div class="cs_bot num03">
                <span></span>
                <span class="cs_bottom_num"><img src="/theme/rt_igcert/image/tel.png" alt="tel 02-6749-1191" class="cs_num_icon">02-6749-1191</span>
            </div>
        </div>
        <div class="cs_bottom fda animated fadeInUpShort" data-id="5">
            <div class="cs_bot num04">
                <span>FDA 의료기기 인증</span>
                <span class="cs_bottom_num"><img src="/theme/rt_igcert/image/tel.png" alt="tel 02-6749-1180" class="cs_num_icon">02-6749-1180</span>
            </div>
            <div class="cs_bot num05">
                <span>FDA 식품, 화장품 인증</span>
                <span class="cs_bottom_num"><img src="/theme/rt_igcert/image/tel.png" alt="tel 02-6749-0702" class="cs_num_icon">02-6749-0702</span>
            </div>
            <div class="cs_bot num06">
                <span></span>
                <span class="cs_bottom_num"><img src="/theme/rt_igcert/image/tel.png" alt="tel 02-6749-0720" class="cs_num_icon">02-6749-0720</span>
            </div>
		</div>
