	...
	<div class="wrap">
		...
		<?php if(defined('_INDEX_')) { ?>
            <div class="pc_ci pc_only">
                <a href="/" title="메인으로">
                    <img src="<!---?php echo G5_THEME_URL ?>/img/ci_img_log.png" alt="logo" class="logo" />
                </a>
			    ...
			    <div class=logo_link_t_einglish>
                    ...
                    <h3 class="logo_link_t_einglish_h3">
                        <span style="padding:5px;"><a href="/igc_eng/" style="color:black;">English</a>
                        </span>
                        <span style="padding:5px;">
                            <a href="#" style="color:black;">中國語</a>
                        </span>
                    </h3>
			    </div>
			    <a href="http://www.igcert.net" target="_blank">
			        <img src="<!---?php echo G5_THEME_URL ?>/img/ci_inquiry.png" alt="이전 홈페이지 보기" />
			     </a>
			    <a href="#certification_search" style="display:inline-block;margin-top:0px;">
                    <img src="<!---?php echo G5_THEME_URL ?>/img/ci_location.png" alt="인증서 검색" />
                </a>
            </div>
		<? } ?>
		-->
		...
		<!----------- PC버전 영문페이지링크 버튼 ----------->
		<button class="button_001" type="button" onclick="location.href='<?php echo G5_URL ?>/igc_eng/'" title="To English/영문사이트"><span class="to_korean">ENG</span></button>
		
		<!----------- PC버전 SNS 버튼 영역 ----------->
		<nav class="sns mobile_no">
			<ul>
				<li><a id="channel-chat-button" href="http://pf.kakao.com/_MdxlzK/chat" onclick="void chatChannel();" title="카카오톡">카카오톡</a></li>
                <!--
		...
		<!----------- 회원메뉴 영역 ----------->
		<a href="javascript:" class="btn_user pc_only" title="회원메뉴"><i class="fa fa-user-o" aria-hidden="true"></i></a>
		<a href="<?php echo G5_URL ?>/bbs/login.php" class="btn_user pc_no" title="회원메뉴"><i class="fa fa-user-o" aria-hidden="true"></i></a>
		<nav class="user">
			<ul>
				<?php if ($is_member) {  ?>
		...
		<nav class="gnb">
			...
			<nav class="sns mobile_only">
				<ul>	
                    ...
                    <!-- 태블릿/모바일버전 영문페이지 링크 버튼 -->                   
			        <div> <a href="<?php echo G5_URL ?>/igc_eng/">To English Website</a> </div>
				</ul>
			</nav>
		</nav>
...
<div class="hd_sch_wr">
	...
	<div class="box">
		...
		<header>
			<h2 style="display:inline;padding-top:5px;">게시판내용 검색</h2>
